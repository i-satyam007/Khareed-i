...
async function main() {
    ...
    const listings = [
        ...
        },
        {
            ...
            isAuction: true,
            auctionFrom: 300,
            auctionTo: new Date(Date.now() + 24 * 60 * 60 * 1000), // 24 hours from now
            ownerId: aman.id,
        },
        {
    ...
    const groupOrders = [
        ...
        },
        {
            ...
            cutoff: new Date(Date.now() + 24 * 60 * 60 * 1000), // 24 hours
            creatorId: khushi.id,
            status: "open",
        },
        {
            ...
            cutoff: new Date(Date.now() + 4 * 60 * 60 * 1000), // 4 hours
            creatorId: satyam.id,
            status: "open",
        },
    ];
