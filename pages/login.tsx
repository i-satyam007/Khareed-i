...
export default function LoginPage() {
  ...
  return (
    <div className="h-screen w-full flex items-center justify-center bg-kh-light overflow-hidden relative">
      ...
      <div className="w-full max-w-md bg-white/5 backdrop-blur-md p-8 rounded-2xl shadow-2xl border border-white/10 mx-4">
        ...
        <div className="text-center mb-8 flex flex-col items-center">
          ...
          <p className="mt-2 text-sm text-gray-400">
            New here? <Link href="/signup" className="font-semibold text-kh-purple hover:text-purple-400 transition-colors">Create an account</Link>
          </p>
        </div>
        ...
        <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div>
            <label className="block text-xs font-semibold text-gray-400 uppercase tracking-wide mb-1">Email or Username</label>
            <input
          ...
          <div>
            ...
            <div className="flex items-center justify-end mt-2">
              <Link href="/forgot-password" className="text-xs font-medium text-kh-purple hover:text-purple-400 hover:underline">Forgot password?</Link>
            </div>
          </div>
          ...
          {showForgotUser && (
            <div className="text-center text-sm p-3 bg-yellow-500/10 rounded-lg border border-yellow-500/20">
              <span className="text-gray-400">Forgot username? </span>
              <Link href="/forgot-username" className="font-semibold text-kh-purple hover:text-purple-400 hover:underline">Recover it here</Link>
            </div>
          )}
